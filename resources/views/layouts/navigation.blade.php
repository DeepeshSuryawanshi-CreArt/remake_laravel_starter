    ...
    <div class="navbar-container container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
            ...
            <ul class="nav navbar-toolbar">
                ...
                <li class="nav-item hidden-float">
                    <a class="nav-link" href="#" id="themeToggle" title="Toggle theme" role="button">
                                    ...
                                    <ul class="blocks-3">
                                        <li>
                                            <a class="thumbnail m-0" href="javascript:void(0)">
                                                <img class="w-full" src="{{ asset('global/photos/placeholder.png') }}"
                                                    alt="..." />
                                            </a>
                                        </li>
                                        <li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" role="menu">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="dropdown-item" href="javascript:void(0)" role="menuitem"><i
                                    class="icon md-power" aria-hidden="true"></i> Logout</button>
                        </form>
                    </div>
                </li>
                <li class="nav-item dropdown">
