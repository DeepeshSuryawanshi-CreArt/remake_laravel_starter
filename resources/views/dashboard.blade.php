    ...
    <div class="page-content container-fluid">
        <div class="row" data-plugin="matchHeight" data-by-row="true">
            ...
            <div class="col-xxl-5 col-lg-5">
                ...
                <div class="card card-shadow mb-4" id="widgetCurrentChart">
        ...
        <ul class="list-group list-group-full list-group-dividered mb-0">
                ...
                <div class="media">
                    <div class="pr-20">
                        <a class="avatar avatar-lg" href="javascript:void(0)">
                            <img class="img-responsive" src="{{ asset('global/portraits/1.jpg') }}" alt="...">
                        </a>
                    </div>
            ...
            <li class="list-group-item">
                <div class="media">
                    <div class="pr-20">
                        <a class="avatar avatar-lg" href="javascript:void(0)">
                            <img class="img-responsive" src="{{ asset('global/portraits/2.jpg') }}" alt="...">
                        </a>
                    </div>
                    <div class="media-body">
            ...
            <li class="list-group-item">
                <div class="media">
                    <div class="pr-20">
                        <a class="avatar avatar-lg" href="javascript:void(0)">
                            <img class="img-responsive" src="{{ asset('global/portraits/3.jpg') }}" alt="...">
                        </a>
                    </div>
                    <div class="media-body">
