...
@section('body-class') animsition page-profile @endsection
@section('content')
            ...
            <div class="col-lg-3">
                ...
                <div class="card card-shadow text-center">
                    <div class="card-block">
                        ...
                        <p class="profile-job">Full Stack AI Developer</p>
                        ...
                        <button type="button" class="btn btn-primary waves-effect waves-classic">Follow</button>
                    </div>
                    ...
                    <div class="panel-body nav-tabs-animate nav-tabs-horizontal" data-plugin="tabs">
                        <ul class="nav nav-tabs nav-tabs-line" role="tablist">
                            <li class="nav-item" role="presentation"><a class="active nav-link" data-toggle="tab"
                                    href="#activities" aria-controls="activities" role="tab">Activities <span
                                        class="badge badge-pill badge-danger">5</span></a></li>
                            <li class="nav-item" role="presentation"><a class="nav-link" data-toggle="tab" href="#profile"
                                    aria-controls="profile" role="tab">Profile</a></li>
                            <li class="nav-item" role="presentation"><a class="nav-link" data-toggle="tab" href="#messages"
                                    aria-controls="messages" role="tab">Messages</a></li>
                            <li class="nav-item dropdown">
                                <a class="dropdown-toggle nav-link" data-toggle="dropdown" href="#"
                                    aria-expanded="false">Menu </a>
                                <div class="dropdown-menu" role="menu">
                                    <a class="active dropdown-item" data-toggle="tab" href="#activities"
                                        aria-controls="activities" role="tab">Activities <span
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active animation-slide-left" id="activities" role="tabpanel">
                                    ...
                                    <li class="list-group-item">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="profile-brief">“Check if it can be corrected with
                                                    overflow : hidden”</div>
                                            </div>
                                        </div>
                                    </li>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="profile-brief">
                                                    <div class="media">
                                                        <a class="pr-20">
                                                            <img class="w-160" src="../../../global/photos/placeholder.png"
                                                                alt="...">
                                                        </a>
                                    ...
                                    <li class="list-group-item">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <small>active 14 minutes ago</small>
                                                <div class="profile-brief">Cras sit amet nibh libero, in gravida
                                                    nulla. Nulla
                                                    vel metus.</div>
                                            </div>
                                        </div>
                                ...
                                <a class="btn btn-block btn-default profile-readMore waves-effect waves-classic"
